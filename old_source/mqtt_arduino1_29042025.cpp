...
///////////////////////////  5.3.2021  KN
//////////////////////////////////////////////////////////////////////////
///////////////////////////  5.5.2025  LSu; modded type checking in parsing for
///float ///////////////////////////
///////////////////////////  NOTE: Support only for two key:value pairs and
///hardcoded as S_value and S_name //////
...
void mqtt::on_subscribe(int mid, int qos_count,
                        const int *granted_qos) // on subcribe callback
{
    ...
    const struct mosquitto_message *message) // on message callback
{
  ...
  if ((mqtt_message[0] == 'I') && (mqtt_message[1] == 'O') &&
      (mqtt_message[2] == 'T') && (mqtt_message[3] == 'J') &&
      (mqtt_message[4] == 'S')) /// ICT course
...

{
      ...
      true) // check if parsing OK mean messagae is JSON format
  {
    ...
    */
    ...
    send_to_Tamk_REST_API_0("http://webapi19sa-1.course.tamk.cloud/v1/weather",
